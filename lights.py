...
def singleSine_top_speed():
    pass

def singleSine_without_sine_step_between():
    pass
            ...
            if i % 6 == 0:
                ...
                while True:
                    ...
                    if mode % 3 == 0:
                        ...
                        np[i % 16]       = hsv_to_rgb((hue + 17.5) % 100,100,sine(s))
                        ...
                        np[(i * 3) % 16] = hsv_to_rgb((hue + 22) % 100,100,sine(s))
                        #np[(i + 7) % 16] = hsv_to_rgb((hue + 33 + 17.5) % 100,100,sine(s))
                        np[(i + 2) % 16] = hsv_to_rgb((hue + 78) % 100,100,sine(s))
                        np.write()
